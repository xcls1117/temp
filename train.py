...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    # Directories
    final_model_dir = '/project/train/models/final'
    image_save_for_dis = '/project/train/result-graphs'
    os.makedirs(final_model_dir, exist_ok=True)
    os.makedirs(image_save_for_dis, exist_ok=True)
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            if rank in [-1, 0]:
                ...
                if plots and ni < 3:
                    ...
                    f = image_save_for_dis + f'/train_batch{ni}.jpg'  # filename
                    Thread(target=plot_images, args=(imgs, targets, paths, f), daemon=True).start()
                    # if tb_writer:
        ...
        if rank in [-1, 0]:
            ...
            if save:
                ...
                copyfile(last, '/project/train/models/final/last.weights')
                if best_fitness == fi:
                    torch.save(ckpt, best)
                    copyfile(best, '/project/train/models/final/best.weights')
                del ckpt
        # end epoch ----------------------------------------------------------------------------------------------------
    # end training
